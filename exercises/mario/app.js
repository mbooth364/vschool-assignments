...
function totalCost() {
    ...
    var cheepsCaught = $("#new-cheeps-caught").val();
    var bobsCaught = $("#new-bobs-caught").val();
    var goombasCaught = $("#new-goombas-caught").val();
    var total = (cheepsCaught*7) + (bobsCaught*7) + (goombasCaught*5);
